...
///Import parking pallet;
pub use pallet_parking;
...
/// Configure the template pallet.
impl pallet_template::Trait for Runtime {
	type Event = Event;
}

/// Configure the parking pallet
impl pallet_parking::Trait for Runtime { }
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		//parking pallet
		ParkingModule: pallet_parking::{Module, Call, Storage},
